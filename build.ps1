...
#   msvc / msvc26         ->  VS 2022 / VS 2026 (Visual Studio generators, no extra setup)
#
# Usage:
#   .\build.ps1                                         # all compilers (msvc, msvc26, gcc, clang)
...
# -- Ensure toolchains (only needed for GCC / Clang) -------------------------
